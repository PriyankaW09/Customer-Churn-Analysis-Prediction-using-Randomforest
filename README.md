...
Any industry that values customer retention can benefit from churn analysis.
...
**In this project tools useed are excel, power BI, jupyter notebook(python) and ML model Randomforest.**
